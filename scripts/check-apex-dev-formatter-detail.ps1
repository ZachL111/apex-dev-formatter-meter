...
$repo = "apex-dev-formatter-meter"
$language = "Rust"
$category = "Developer tools"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/apex-dev-formatter-walkthrough.md")) {
